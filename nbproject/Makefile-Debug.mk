...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/io-dse: ${OBJECTFILES}
	...
	g++ -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/io-dse ${OBJECTFILES} ${LDLIBSOPTIONS} -lpthread -lcrypto -lssl
...
${OBJECTDIR}/AmortizedNlogN.o: AmortizedNlogN.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O3 -I/usr/include/openssl -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/AmortizedNlogN.o AmortizedNlogN.cpp

${OBJECTDIR}/AmortizedOneChoice.o: AmortizedOneChoice.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O3 -I/usr/include/openssl -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/AmortizedOneChoice.o AmortizedOneChoice.cpp

${OBJECTDIR}/AmortizedPiBAS.o: AmortizedPiBAS.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O3 -I/usr/include/openssl -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/AmortizedPiBAS.o AmortizedPiBAS.cpp

${OBJECTDIR}/AmortizedTwoChoice.o: AmortizedTwoChoice.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O3 -I/usr/include/openssl -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/AmortizedTwoChoice.o AmortizedTwoChoice.cpp
...
${OBJECTDIR}/DeAmortizedBASClient.o: DeAmortizedBASClient.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O3 -I/usr/include/openssl -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DeAmortizedBASClient.o DeAmortizedBASClient.cpp

${OBJECTDIR}/DeAmortizedBASServer.o: DeAmortizedBASServer.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O3 -I/usr/include/openssl -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DeAmortizedBASServer.o DeAmortizedBASServer.cpp

${OBJECTDIR}/DeAmortizedSDdBAS.o: DeAmortizedSDdBAS.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O3 -I/usr/include/openssl -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DeAmortizedSDdBAS.o DeAmortizedSDdBAS.cpp

${OBJECTDIR}/DeAmortizedSDdGeneral.o: DeAmortizedSDdGeneral.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O3 -I/usr/include/openssl -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DeAmortizedSDdGeneral.o DeAmortizedSDdGeneral.cpp

${OBJECTDIR}/DeAmortizedSDdNlogN.o: DeAmortizedSDdNlogN.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O3 -I/usr/include/openssl -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DeAmortizedSDdNlogN.o DeAmortizedSDdNlogN.cpp

${OBJECTDIR}/NlogNClient.o: NlogNClient.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O3 -I/usr/include/openssl -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/NlogNClient.o NlogNClient.cpp

${OBJECTDIR}/NlogNSDdGeneralClient.o: NlogNSDdGeneralClient.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O3 -I/usr/include/openssl -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/NlogNSDdGeneralClient.o NlogNSDdGeneralClient.cpp

${OBJECTDIR}/NlogNServer.o: NlogNServer.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O3 -I/usr/include/openssl -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/NlogNServer.o NlogNServer.cpp

${OBJECTDIR}/NlogNStorage.o: NlogNStorage.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O3 -I/usr/include/openssl -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/NlogNStorage.o NlogNStorage.cpp
...
${OBJECTDIR}/OneChoiceSDdGeneralClient.o: OneChoiceSDdGeneralClient.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O3 -I/usr/include/openssl -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/OneChoiceSDdGeneralClient.o OneChoiceSDdGeneralClient.cpp

${OBJECTDIR}/OneChoiceSDdGeneralServer.o: OneChoiceSDdGeneralServer.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O3 -I/usr/include/openssl -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/OneChoiceSDdGeneralServer.o OneChoiceSDdGeneralServer.cpp
...
${OBJECTDIR}/StorageSDDPiBAS.o: StorageSDDPiBAS.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O3 -I/usr/include/openssl -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/StorageSDDPiBAS.o StorageSDDPiBAS.cpp

${OBJECTDIR}/StorageSDd.o: StorageSDd.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O3 -I/usr/include/openssl -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/StorageSDd.o StorageSDd.cpp

${OBJECTDIR}/TransientStorage.o: TransientStorage.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O3 -I/usr/include/openssl -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/TransientStorage.o TransientStorage.cpp

${OBJECTDIR}/TransientStorage2D.o: TransientStorage2D.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O3 -I/usr/include/openssl -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/TransientStorage2D.o TransientStorage2D.cpp

${OBJECTDIR}/TwoChoiceWithOneChoiceClient.o: TwoChoiceWithOneChoiceClient.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O3 -I/usr/include/openssl -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/TwoChoiceWithOneChoiceClient.o TwoChoiceWithOneChoiceClient.cpp

${OBJECTDIR}/TwoChoiceWithOneChoiceServer.o: TwoChoiceWithOneChoiceServer.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O3 -I/usr/include/openssl -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/TwoChoiceWithOneChoiceServer.o TwoChoiceWithOneChoiceServer.cpp

${OBJECTDIR}/TwoChoiceWithOneChoiceStorage.o: TwoChoiceWithOneChoiceStorage.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O3 -I/usr/include/openssl -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/TwoChoiceWithOneChoiceStorage.o TwoChoiceWithOneChoiceStorage.cpp
